...
import { Users, Plus, Eye, Edit, CheckCircle, XCircle, Star } from "lucide-react"
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell>Ahmad Santoso</TableCell>
                <TableCell>25 tahun</TableCell>
                <TableCell>Rp 2.450.000</TableCell>
                <TableCell>
              ...
              <TableRow>
                <TableCell>Budi Pratama</TableCell>
                <TableCell>22 tahun</TableCell>
                <TableCell>Rp 890.000</TableCell>
                <TableCell>
                  <Badge variant="default">Terverifikasi</Badge>
                </TableCell>
              ...
              <TableRow>
                <TableCell>Citra Melati</TableCell>
                <TableCell>19 tahun</TableCell>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h3 className="font-medium mb-2">Member Bronze</h3>
              <p className="text-sm text-muted-foreground mb-2">Pembelian &lt; Rp 1.000.000</p>
              <div className="flex items-center space-x-2">
                <Progress value={75} className="flex-1" />
                <span className="text-sm">156 member</span>
              </div>
            </div>
            <div>
              <h3 className="font-medium mb-2">Member Silver</h3>
              <p className="text-sm text-muted-foreground mb-2">Pembelian Rp 1.000.000 - 5.000.000</p>
              <div className="flex items-center space-x-2">
                <Progress value={45} className="flex-1" />
                <span className="text-sm">89 member</span>
              </div>
            </div>
            <div>
              <h3 className="font-medium mb-2">Member Gold</h3>
              <p className="text-sm text-muted-foreground mb-2">Pembelian &gt; Rp 5.000.000</p>
              <div className="flex items-center space-x-2">
                <Progress value={20} className="flex-1" />
                <span className="text-sm">23 member</span>
              </div>
            </div>
          </div>
        </CardContent>

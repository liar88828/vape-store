...
import { SalesData, salesData, salesDataModal, SalesDataModal } from "@/lib/data"
import {
    Dialog,
    DialogClose,
    DialogContent,
...
import { formatRupiah } from "@/lib/my-utils";
                ...
                <TableRow key={index}>
                  ...
                  <TableCell>
                    ...
                    <TableCell className={ 'space-x-2' }>
                        <ModalSalesDetail data={ sale }/>
                        <ModalInvoice data={ salesDataModal }/>
                    </TableCell>
...
export function ModalSalesDetail({ data }: { data: SalesData }) {
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Transaksi oleh { data.customer } pada { data.date }
                    </DialogDescription>
                </DialogHeader>
                <div className="space-y-2 text-sm">
                    <p><strong>Nama Pelanggan:</strong> { data.customer }</p>
                    <p><strong>Tanggal:</strong> { data.date }</p>
                    <p><strong>Total Pembelian:</strong> { data.total.toLocaleString("id-ID", {
                        style: "currency",
                        currency: "IDR"
                    }) }</p>
                    <p><strong>Jumlah Barang:</strong> { data.items } item</p>
                </div>
                <DialogClose asChild>
